        ...
        <div className="relative">
            <div className="flex flex-col gap-[7px]">
                ...
                <div className="grid grid-cols-3 gap-[7px]">
                    <button
                        onClick={onDecrease}
                        className="rounded-xl bg-gradient-to-r h-[42px] from-[#ED172B] to-[#931216]  text-2xl font-bold text-white"
                    >
                        -
                    </button>
                    <button
                        onClick={() => setIsMultiplierActive(!isMultiplierActive)}
                        className="rounded-xl h-[42px] bg-[#2A2A2A] text-lg text-white"
                        style={{
                    ...
                    <button
                        onClick={onIncrease}
                        className="rounded-xl bg-gradient-to-r from-[#21CC51] to-[#16E555] h-[42px] text-2xl font-bold text-white"
                    >
                        +
                    </button>
                </div>
