            ...
            <div className="relative h-[130px] sm:h-[160px] md:h-[180px] lg:h-[200px] rounded-2xl outline outline-1 outline-gray-700">
                {onChangeToken && (
                    <button
                        ...
                        className="bg-[#2A2A2A] absolute right-2 sm:right-3 md:right-4 top-2 sm:top-3 md:top-4 flex items-center gap-1 sm:gap-2 rounded-lg px-2 sm:px-3 py-1.5 sm:py-2 text-xs sm:text-sm text-200-white outline outline-1 outline-gray-700 hover:text-white"
                    >
